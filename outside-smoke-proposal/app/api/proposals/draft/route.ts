...
export async function POST(req: NextRequest) {
  ...
  // In production, derive user_id from the request's auth cookie/session.
  // For this skeleton we accept user_id if provided; otherwise require server to set it.
  ...
  try {
    const payload = {
      ...
      current_section: body.current_section ?? null,
